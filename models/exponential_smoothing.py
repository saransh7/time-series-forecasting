        ...
        for param_seasonal in seasonal:
            ...
            for split_count in range(1,validation_points + 2):
                ...
                try:
                    ...
                    ets_fcast = ets_fit.forecast(steps=c.valid_months)
                    error = f.root_mean_square_error(demand_valid, ets_fcast)
                except:
                    error = float('Inf')
